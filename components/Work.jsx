...
const Work = () => {
    return (
        <div name='work' className='w-full py-10 md:py-20 text-gray-300 bg-[#0a192f]'>
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                ...
                <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
                    ...
                    {/* Grid Item */}
                    <div className="shadow-lg bg-[url('../public/Netflix.png')] shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div ">
                        {/* Hover Effects */}
                        <div className='opacity-0 group-hover:opacity-100'>
                            <span className='text-2xl font-bold text-white tracking-wider'>
                                React JS Application
                            ...
                            <div className='pt-8 text-center'>
                                <Link passHref href='https://netflix-by-me.netlify.app/'>
                                    <a target='_blank'>
                                        <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                                            Demo
                                        </button>
                                ...
                                <Link passHref href='https://github.com/Hemant-0000/Netflix-Klone'>
                                    <a target='_blank'>
                                        <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                                            Code
                                        </button>
